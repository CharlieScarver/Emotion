...
namespace Emotion.Graphics
{
    public sealed class Renderer
    {
        ...
        {
            string defaultVert = Utilities.ReadEmbeddedResource("EmotionTest.Embedded.Shaders.DefaultVert.glsl");
            string defaultFrag = Utilities.ReadEmbeddedResource("EmotionTest.Embedded.Shaders.DefaultFrag.glsl");
